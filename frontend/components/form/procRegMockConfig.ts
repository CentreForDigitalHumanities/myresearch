    ...
    steps: [
        {
            ...
            substeps: [
                    ...
                    questions: [
                        {
                            ...
                            labelEn:
                                "Who is ultimately responsible for the study at UU?",
                            type: "text",
                            order: 1,
                        ...
                        },
                        {
                            ...
                            order: 2,
                            labelNl:
                                "Wie werkt er binnen de UU nog meer mee aan de studie?",
                ...
                },
                {
                    ...
                    sideConfig: {
                        questions: [
                            {
                                textNl: "Kan ik een faculteit invullen waarbij de eindverantwoordelijke niet werkzaam is?",
                                textEn: "Can I fill in a faculty where the responsible person is not employed?",
                                link: "dummy",
                            },
                            {
                                textNl: "Kan ik een faculteit invullen waarbij de eindverantwoordelijke niet werkzaam is?",
                            ...
                            {
                                textNl: "Wat als een studie door meerdere departementen wordt uitgevoerd?",
            ...
            sideConfig: {
                questions: [
                    ...
                    {
                        textNl: "Ik heb deze naam al ergens anders opgegeven. Waarom moet ik dit nog een keer doen?",
                        textEn: "I have already provided this name elsewhere. Why do I need to do this again?",
                        link: "dummy",
                    },
                ],
            },
        },
        {
            ...
            questions: [
                {
                    ...
                    descriptionEn:
                        "This is the date you start collecting personal data.",
                    type: "date",
                    order: 1,
                    required: true,
                },
            ...
            sideConfig: {
                questions: [
                    {
                        textNl: "Wat gebeurt er als de hier opgegeven periode is verstreken?",
