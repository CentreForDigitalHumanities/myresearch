        ...
        <div class="uu-sidebar-container uu-sidebar-right">
            <div class="uu-sidebar-content">
                ...
                <div class="uu-container">
                    {{
                        $t(
                            "MyResearch is a website that helps researchers with submitting a request to register a research. On this website you can register your research at the processing registry. First, however, you should fill in the roadmap",
                        )
                    }}
                </div>
                <h2 class="uu-sidebar-header-linked">
