...
export const mockQuestions: MockQuestions = {
    processingRegistry: {
        ...
        "Why are bananas curved?": [
            { text: "Because they are yellow.", url: null, image: null },
        ],
    },
    ethicalCommission: {
        "Where can I find the documents that I have to submit?": [
            ...
            {
                text: "You can also find the links to the documents during the application itself.",
                url: null,
                image: null,
            },
        ],
        "How long does it take to receive a reply after submitting?": [
            { text: "No idea.", url: null, image: null },
        ],
